 ...
 * @returns {Object|null} clerkUser - Usuario completo de Clerk (incluye métodos y propiedades de Clerk)
...
export function useAuth() {
    ...
    return {
        ...
        // Información adicional de Clerk (útil para casos específicos)
        clerkUserId,
        isSignedIn,
    };
}
