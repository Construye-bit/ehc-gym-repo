            ...
            <View className="flex-1 px-6 pt-16 pb-8">
                ...
                <View className="bg-amber-50 rounded-xl p-6 mb-6 border border-amber-200">
                    <Text className="text-base text-gray-700 leading-6 mb-4">
                        Para poder utilizar el Asistente Virtual con IA y disfrutar de todos los beneficios,
                    ...
                    <View className="space-y-3">
                        <View className="flex-row items-start">
                            ...
                            <Text className="ml-3 text-gray-700 flex-1">
                                Acceder al Asistente Virtual con IA personalizada
                            </Text>
                        </View>
                        ...
                        <View className="flex-row items-start mt-3">
                            <Ionicons name="checkmark-circle" size={24} color="#10b981" />
                            <Text className="ml-3 text-gray-700 flex-1">
                                Consultar tus métricas de salud y progreso
                            </Text>
                        </View>
