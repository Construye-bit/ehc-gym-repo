...
const steps = [
  {
    ...
    description: "Escanea el código QR y descarga EHC GYM App en Android.",
  },
  {
    number: "02",
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-8 animate-fade-in-up">
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-lg">
                Rutinas personalizadas con coach de IA, reserva de turnos al
                instante y control completo de tu progreso físico. Todo en una
                sola app.
              </p>
              ...
              <div className="flex items-center gap-4 pt-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    <strong className="text-gray-900">Comunidad</strong> activa
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            { value: "Todos", label: "Niveles de entrenamiento" },
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-600 mt-4">
              Una plataforma completa que combina tecnología, entrenadores y
              motivación para que alcances tus metas.
            </p>
          </div>
      ...
      <section
        id="how-it-works"
        className="py-20 lg:py-28 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100"
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16">
      ...
      <section
        id="download"
        className="py-20 lg:py-28 bg-gray-900 text-white relative overflow-hidden"
      >
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-12">
            Únete a los miembros que ya transformaron su experiencia de
            entrenamiento con EHC GYM App.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
            ...
            <div className="flex flex-col items-center justify-center bg-white p-6 rounded-2xl shadow-2xl">
              <QRCodeSVG
                value={
                  import.meta.env.VITE_URL_APK_APP || "https://example.com"
                }
                size={160}
                level="H"
                marginSize={1}
            ...
            {/* Direct download link (mobile touch target) */}
            <a
              href={import.meta.env.VITE_URL_APK_APP || "https://example.com"}
              download
              className="inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-yellow-500 hover:bg-yellow-600 text-white rounded-xl text-base font-semibold transition-colors shadow-lg shadow-yellow-500/25 w-full sm:w-auto"
            >
              <Download className="w-5 h-5" />
              Descargar APK
            </a>
            ...
            <div className="text-left space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">
                    Solo necesitas tu membresía activa
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-3">
      ...
      <section className="py-16 lg:py-20 bg-gradient-to-br from-yellow-500 to-yellow-600">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-yellow-50 mb-8">
            Descarga EHC GYM App y empieza a entrenar de forma más inteligente
            hoy mismo.
          </p>
          <a
            href="#download"
          ...
          <div className="grid md:grid-cols-3 gap-8 items-start">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-400 text-sm max-w-xs">
                Tu gimnasio en el bolsillo. Entrena, progresa y logra tus metas
                con la app de EHC GYM.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-gray-400 text-sm">
                ...
                <a
                  href="mailto:construyebit@uptc.edu.co"
